...
- [恋するへびべあ診断](https://kumatype-shindan.xyz): 20問・1〜2分で、16種類のクマ恋愛タイプを確認できます。
- [くまタイプ診断 MBTI 16タイプ一覧](https://kumatype-shindan.xyz/types): 各タイプの名前、MBTI風コード、恋愛傾向、相性の見方を見直せます。
- [くまタイプ相性一覧](https://kumatype-shindan.xyz/compatibility): 自分と相手のクマタイプを選び、相性スコアと読み方を確認できます。
- [ラブタイプ診断64](https://kumatype-shindan.xyz/lovecharacter64): 恋愛での距離感、甘え方、現実感、自由さなどから、64タイプの恋愛キャラクター結果を見られる新しい診断です。
- [ラブタイプ診断64の結果一覧](https://kumatype-shindan.xyz/lovecharacter64/results): 64タイプの画像、タイプコード、恋愛傾向を一覧で確認できます。
- [3D KUMA](https://kumatype-shindan.xyz/3d-bears): 16タイプをぬいぐるみ風・クレイフィギュア風の3D画像で見比べられます。

## レビュー対象の選び方

質問・16タイプ・相性・スコア計算の修正は、対象の公開データまたはテストを明記してください。サイト表示だけの問題と、公開パッケージ内のデータ問題を分けると、安全に再現しやすくなります。
